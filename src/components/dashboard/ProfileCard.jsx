    ...
    >
      <div className="flex flex-col md:flex-row items-center md:items-start gap-4">
        <Avatar 
          size={96} 
          icon={<UserOutlined />} 
          src={profile.foto ? profile.foto.trim() : null}
          className="border-2 border-blue-500"
        />
        <div className="flex flex-col">
          <Title level={4} className="m-0 text-center md:text-left">{profile.nama}</Title>
          <Text type="secondary" className="text-center md:text-left">{profile.nipBaru}</Text>
